...
// -------------------------------------------------------------------------- //
//                                                                            //
//   WCL Bluetooth Framework Messages.                                        //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
class CwclBluetoothLeConnectionParamsChangedMessage : public CwclBluetoothMessage
{
...
private:
	CwclBluetoothGattServerClientConnectionParams*	FParams;
...
public:
	...
	CwclBluetoothGattServerClientConnectionParams* GetParams() const;
	__declspec(property(get = GetParams)) CwclBluetoothGattServerClientConnectionParams* Params;
};
...
public:
	CwclBluetoothGattServerCharMessage(const unsigned char Id, const wclBluetoothApi Api,
		const __int64 Address, CwclBluetoothGattServerClientConnectionParams* const Params,
...
class CwclBluetoothLeGattServerWriteMessage : public CwclBluetoothGattServerCharMessage
{
...
public:
	CwclBluetoothLeGattServerWriteMessage(const wclBluetoothApi Api, const __int64 Address,
		CwclBluetoothGattServerClientConnectionParams* const Params,
		CwclGattLocalCharacteristic* const Characteristic, const unsigned char* const Data,
		const unsigned long Size);
...
class CwclBluetoothLeGattServerReadMessage : public CwclBluetoothGattServerCharMessage
{
	DISABLE_COPY(CwclBluetoothLeGattServerReadMessage);

private:
	CwclGattLocalCharacteristicValue* FValue;
...
public:
	...
	CwclGattLocalCharacteristicValue* GetValue() const;
	__declspec(property(get = GetValue)) CwclGattLocalCharacteristicValue* Value;
};

// Microosft specific read request message.
class CwclMicrosoftGattServerReadMessage : public CwclBluetoothLeGattServerReadMessage
{
	DISABLE_COPY(CwclMicrosoftGattServerReadMessage);
	
private:
	HANDLE		FEvent;
	
public:
	CwclMicrosoftGattServerReadMessage(const __int64 Address,
		CwclBluetoothGattServerClientConnectionParams* const Params,
		CwclGattLocalCharacteristic* const Characteristic,
		CwclGattLocalCharacteristicValue* const Value, const HANDLE Event);
	virtual ~CwclMicrosoftGattServerReadMessage();
	
	HANDLE GetEvent() const;
	__declspec(property(get = GetEvent)) HANDLE Event;
};
...
/* Microosft BLE pairing speicific messages. */
