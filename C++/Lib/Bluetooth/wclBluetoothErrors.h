...
// -------------------------------------------------------------------------- //
//                                                                            //
//   WCL Bluetooth Framework: Error codes and exceptions.                     //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
/// <summary> Unable to opend the Bluetooth Manager. </summary>
...
///   <para> Usualy this error appears if you try to connect to device that is paired on PC side
...
/// <summary> Operation has been cancelled by user. </summary>
...
/// <summary> Pairing operationis executing. </summary>
...
/// <summary> Authentication (pairng) with a remote Bluetooth device is failed. </summary>
...
/// <summary> Unable to set client authentication and/or encription states. </summary>
...
/// <summary> Unable to aquire the connections mutex object. </summary>
...
/// <summary> Unable to aquire the SDP mutex object. </summary>
...
/// <summary> Unable to set server authentication and/or encription
///   states. </summary>
...
/// <summary> Unablet o get connected state of the device. </summary>
...
/// <summary> Unable start Win RT asyncronous operation. </summary>
...
/// <summary> Disoonnect operation failed because device is not connected. </summary>
...
/// <summary> Attribute reading is not permited. </summary>
...
///   longer than maximum PDU size (MTU). Ap application must use Write With
...
/// <summary> The URL passsed to the Eddytone URL Beacon is empty or too
...
/// <summary> Attemp to connect to not previously discovered Bluetooth LE
...
/// <summary> The requisted feature is not supported bu a Bluetooth LE
///   driver. </summary>
...
/// <summary> Unable to get information ablout Bluetooth LE service that
...
/// <summary> GATT protocol error. </summary>
...
/// <summary> Unbale to publish local GATT service. </summary>
const int WCL_E_BLUETOOTH_LE_GATT_SERVER_START_FAILED = WCL_E_BLUETOOTH_LE_BASE + 0x0099;
/// <summary> Unable to create local GATT sevrice. </summary>
...
/// <summary> The GATT server has lready been initialized. </summary> 
...
/// <summary> Can not ceate HID devices list. </summary>
...
/// <summary> The requisted feature is not supported. Probably because
