...
class CwclGattLocalCharacteristicValue;
...
typedef enum
{
	...
	///   charactersitic supports such method. If a characteristic does not
...
typedef struct
{
	/// <summary> The connection inverval. </summary>
	/// <remarks> The connection inverval is defined as 1.25ms increments,
...
/// <summary> The structure represets the Bluetooth LE GATT preferred connection
///   parameters. </summary>
typedef struct
{
	/// <summary> The minimum connection inverval. </summary>
	/// <remarks> The connection inverval is defined as 1.25ms increments,
	///   ranging from 6 to 3200. Time(ms) = Interval * 1.25ms. </remarks>
	unsigned short MinInterval;
	/// <summary> The maximum connection inverval. </summary>
	/// <remarks> The connection inverval is defined as 1.25ms increments,
	///   ranging from 6 to 3200. Time(ms) = Interval * 1.25ms. </remarks>
...
typedef struct
{
	/// <summary> The Bluetooith LE captured packet header. </summary>
...
///   is executing. </param>
/// <param name="Value"> The local GATT characteristic value object. An
///   application must call the <c>SetData</c> method of the passed object to
///   provide characteristic's data. </param>
/// <seealso cref="CwclGattServerClient" />
/// <seealso cref="CwclGattLocalCharacteristic" />
/// <seealso cref="CwclGattLocalCharacteristicValue" />
#define wclGattLocalCharacteristicReadEvent(_event_name_) \
	...
	CwclGattLocalCharacteristicValue* const Value)
...
/// <param name="Size"> The received data size. </param>
/// <seealso cref="CwclGattServerClient" />
/// <seealso cref="CwclGattLocalCharacteristic" />
...
protected:
	...
	/// <summary> Gets the message receiver object. </summary>
	/// <value> A <see cref="CwclMessageReceiver" /> obejct used in
	///   radio. </value>
	/// <remarks> For internal use only. </remarks>
	/// <seealso cref="CwclMessageReceiver" />
...
public:
    ...
    ///   is availbale. <c>False</c> otherwise. </returns>
    bool GetAvailable() const;
	/// <summary> Gets a Radio hardware state. </summary>
    /// <value> <c>True</c> if a Bluetooth hardware represented by this Radio
    ///   is availbale. <c>False</c> otherwise. </value>
    ...
    /// <returns> Returns <c>true</c> if the Radio is available and supports
    ///   Bluetooth Low Evenrgy. Returns <c>false</c> otherwise. </returns>
...
public:
	...
	/// <summary> The veen tfires when a remote device requests an Out Of Band
...
public:
	/// <summary> Create new Classis Bluetooth client connection. </summary>
...
public:
    /// <summary> Create new Classis Bluetooth server connection. </summary>
    /// <param name="Radio"> The Radio object that owns the connection. </param>
    /// <remarks> <para> An application must never create this class directly.
    ///   Instead of that an application must use upper-level methods and
    ///   classes. </para>
    ...
    ///   additinal attributes it should handle the event. By default no
...
protected:
	...
	/// <param name="Length"> On output conttains a characteristic value length in
	///   bytes. </param>
    /// <returns> If the function succeed the return value is
    ///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
    ///   the WCL error codes. </returns>
	...
	///   connection parameters. </summary>
	/// <param name="Params"> If the function completed with susccess on output
...
public:
    ...
    int WriteClientConfiguration(wclGattCharacteristic Characteristic,
		const bool Subscribe, const wclGattOperationFlag Flag,
		const wclGattProtectionLevel Protection,
		const wclGattSubscribeKind SubscribeKind);
    ...
    /// <seealso cref="wclGattCharacteristic" />
	/// <seealso cref="wclGattSubscribeKind" />
    int Subscribe(wclGattCharacteristic Characteristic,
		const wclGattSubscribeKind SubscribeKind);
    ...
    /// <seealso cref="wclGattCharacteristic" />
	/// <seealso cref="wclGattSubscribeKind" />
    int Unsubscribe(wclGattCharacteristic Characteristic,
		const wclGattSubscribeKind SubscribeKind);
	...
	///   <c>GetConnectionParams</c> method to retrive the current connection
	///   parameters. </para>
	///   <para> This feature is supported with <c>BLED112</c> dongle and with
	///   <c>Microsoft</c> Bluetooth drivers on <c>Windows 11</c> and
	///   above. </para> </remarks>
...
public:
	...
	/// <summary> Gets the service's publising result code. </summary>
	/// <returns> One of WCL errors code indicates the publising result. </returns>
	/// <remarks> If publishin the service was failed this property contains the
	///   failure reason code. </remarks>
	int GetError() const;
	/// <summary> Gets the service's publising result code. </summary>
	/// <value> One of WCL errors code indicates the publising result. </value>
	/// <remarks> If publishin the service was failed this property contains the
	///   failure reason code. </remarks>
	__declspec(property(get = GetError)) int Error;
...
/// <summary> The class represents a local GATT characteristic value that
///   sends as respond to the read request. </summary>
...
class CwclGattLocalCharacteristicValue
{
	DISABLE_COPY(CwclGattLocalCharacteristicValue);
...
public:
	...
	///   intrnally when needed. </remarks>
	CwclGattLocalCharacteristicValue();
	/// <summary> Frees the object. </summary>
	/// <remarks> An application must not destroy this class. Instead of
	///   calling destructor an application must call the <c>Release</c>
	///   method. </remarks>
	virtual ~CwclGattLocalCharacteristicValue();
	
	/// <summary> Increments the reference count for an object. This method
	///   should be called for every new reference to an object. </summary>
	void AddRef();
	...
	///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
	///   the WCL error codes. </returns>
	int SetData(const unsigned char* const Data, const unsigned long Size);
...
///   implementation connection parameters. </summary>
class CwclBluetoothGattServerClientConnectionParams
{
	DISABLE_COPY(CwclBluetoothGattServerClientConnectionParams);
	
public:
	/// <summary> Creates new parameters object. </summary>
	CwclBluetoothGattServerClientConnectionParams();
	/// <summary> Frees the object. </summary>
	virtual ~CwclBluetoothGattServerClientConnectionParams();
};
...
protected:
	...
	/// <seealso cref="CwclBluetoothGattServerClientConnectionParams" />
	virtual void AfterConnect(
		CwclBluetoothGattServerClientConnectionParams* const Params);
...
public:
	...
	/// <summary> Fress the object. </summary>
...
protected:
	...
	/// <param name="Value"> The local GATT characteristic value object. An
	///   application must call the <c>SetData</c> method of the passed object
	///   to provide characteristic's data. </param>
	...
	virtual int HalInitialize() = 0;
	/// <summary> Implements a driver specific code to unitnialize Bluetooth LE
	///   GATT Server. </summary>
	/// <returns> If the function succeed the return value is
	///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
	///   the WCL error codes. </returns>
...
public:
    ...
    /// <returns> <c>True</c> if the Bleacon monitoring is running. </returns>
    bool GetMonitoring() const;
	/// <summary> Gets Beacon Monitoring state. </summary>
    /// <value> <c>True</c> if the Bleacon monitoring is running. </value>
...
public:
	...
	/// <summary> Gets the service's daya. </summary>
...
public:
	...
	/// <returns> Teh value indicates whether or not the Extended Advertising format
...
public:
	...
	///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
	///   the WCL error codes. </returns>
	/// <remarks> This is asynchronous method. When operation complets the
	...
	/// <returns> The IR sensor sesitivity. </returns>
	/// <seealso cref="wclWiiRemoteIrSensitivity" />
	wclWiiRemoteIrSensitivity GetIrSensitivity() const;
	/// <summary> Gets the current IR sensor sensitivity. </summary>
	/// <value> The IR sensor sesitivity. </value>
	/// <seealso cref="wclWiiRemoteIrSensitivity" />
	...
	/// <summary> The evtn fires when the Drums extension state has been
	///   changed. </summary>
	/// <param name="Sender"> The object initiates the event. </param>
	/// <param name="Drums"> The current state of the Drums extension. </param>
	/// <seealso cref="wclWiiRemoteDrums" />
...
public:
    ...
    /// <returns> The Bluetooth sevrice's UUID. </returns>
    GUID GetService() const;
    /// <summary> Sets the service's UUID that should be used
    ///   for connection. </summary>
    /// <param name="Value"> The Bluetooth sevrice's UUID. </param>
    ...
    ///   for connection. </summary>
    /// <value> The Bluetooth sevrice's UUID. </value>
    /// <remarks> If an application changes the property when connection is
    ///   active the <see cref="wclEBluetoothClient" /> exception
    ///   raises. </remarks>
    /// <exception cref="wclEBluetoothClient"></exception>
    ...
    ///   resolve required channel number by quering a target devices SDP
    ///   using the service's UUID. In this case it will use the first found
    ///   service that mutches the UUID. </para> </remarks>
    /// <exception cref="wclEBluetoothClient"></exception>
    /// <exception cref="wclEInvalidArgument"></exception>
    ...
    ///   is active the <see cref="wclEBluetoothClient" /> exception
    ///   raises. </para>
    ///   <para> The Encryption can be truend on (<c>True</c>) only if
    ///   the <c>Authentication</c> property si also set to
...
protected:
	/// <summary> Fires the <c>OnClosed</c> event. </summary>
    /// <param name="Reason"> Indictaes closing reason. </param>
...
public:
	...
	/// <summary> Unintializes the Bluetooth LE GATT Server. </summary>
	/// <returns> If the function succeed the return value is
	///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
	///   the WCL error codes. </returns>
